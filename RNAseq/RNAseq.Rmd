...
read.counts <- importStarCounts(folder = "../../data_files/star_v5/", 
                                column = 4)
...
write.table(x = read.counts,
            file = "../../data_files/RNAseq_read_counts/all_read.counts.txt",
            sep = "\t",
            col.names = T)
...
write.table(x = read.counts, 
            file = "../../data_files/RNAseq_read_counts/GSC_and_nonGSC_readcounts.txt",
            sep = "\t",
            col.names = T)
...
write.table(x = voom.all_HGNC, 
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_nonGSC_all_differentially_expressed_genes.csv",
            quote = FALSE, 
            sep = ",", 
            row.names = T)
write.table(x = voom_top_HGNC,
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_nonGSC_top_pval05_differentially_expressed_genes.csv", 
            quote = FALSE, 
            sep = ",",
            row.names = T)
...
pdf("../../data_files/GSEA/GSC_vs_nonGSC_gsea.pdf", 14,8)
...
```{r GSC_vs_HNPC}
# load in the star counts
read.counts <-importStarCounts("../../data_files/star_v5/", column = 4)
# removing uneeded text from column names
colnames(read.counts) <- gsub(pattern = "_dna_ReadsPerGene.out.tab", 
                              replacement = "",
                              colnames(read.counts))
...
# write the read counts for later reference
write.table(x = read.counts,
            file = "../../data_files/GSEA/GSC_vs_HNPC_read.counts.txt",
            sep = "\t",
            col.names = T)
...
write.table(x = voom.all_HGNC, 
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_HNPC_all_differentially_expressed_genes.csv",
            quote = FALSE,
            sep = ",",
            row.names = F)
write.table(x = voom_top_HGNC, 
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_HNPC_top_pval05_differentially_expressed_genes.csv",
            quote = FALSE, 
            sep = ",",
            row.names = F)
...
pdf("../../data_files/GSEA/GSC_vs_HNPC_gsea.pdf", 14,8)
topPathwaysUp <- fgseaRes[ES > 0][head(order(pval), n=10), pathway]
topPathwaysDown <- fgseaRes[ES < 0][head(order(pval), n=10), pathway]
topPathways <- c(topPathwaysUp, rev(topPathwaysDown))
print(
...
read.counts <- read.table("../../data_files/RSEM_out/rsem_isoforms_matrix.txt")
...
write.table(x = voom.all_HGNC,
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_nonGSC_all_differentially_expressed_transcripts.csv",
            quote = FALSE, 
            sep = ",",
            row.names = F)
write.table(x = voom_top_HGNC, 
            file = "../../data_files/RNAseq_expressed_genes/GSC_vs_nonGSC_top_pval05_differentially_expressed_transcripts.csv",
            quote = FALSE, 
            sep = ",",
            row.names = F)
...
#load in the star counts
read.counts <- importStarCounts(folder = "../../data_files/SRP040525_gene_counts/", 
                                column = 4)
