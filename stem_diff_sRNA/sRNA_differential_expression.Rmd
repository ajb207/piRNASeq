...
write.table(x = voom.sRNA, 
            file = "../data/GSC_vs_nonGSC_targeting_sequences_differential_expression/GSC_vs_nonGSC_all_differentially_expressed_targeting_sequences.csv",
            quote=F, 
            row.names = T, 
            col.names = T, 
            sep = ",")
write.table(x = voom.top.sRNA, file = "../data/GSC_vs_nonGSC_targeting_sequences_differential_expression/GSC_vs_nonGSC_top_pval<05_differentially_expressed_targeting_sequences.csv",
            quote=F,
            row.names = T,
            col.names = T, 
            sep = ",")
...
#import the desired read counts
read.counts <- read.csv(file = "../sRNA_counts/sra_all_sa_og_norRNA_25_33_read.counts.txt",
