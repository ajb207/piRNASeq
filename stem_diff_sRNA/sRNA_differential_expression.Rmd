...
#voom fold changesmiRNA_alignments
voom_sRNA <- topTable(fit, coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts) )
voom_top <- topTable(fit,coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts),lfc = 0,p.value = 0.05)
#voomNormExp <- voomCounts$E
#rm(celltype);rm(design.array); rm(design); rm(dge.counts)
#my name function
...
voom_sRNA <- topTable(fit, coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts) )
voom_top <- topTable(fit,coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts),lfc = 2,p.value = 0.05)
