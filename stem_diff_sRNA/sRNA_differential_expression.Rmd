...
read.counts <- read.csv(file = "../sRNA_counts/small_sa_og_norRNA_25_33_counts.txt", 
                        stringsAsFactors=FALSE,
                        row.names = 1)[,]
...
lncRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_lncRNA.txt",
                     header = FALSE, 
                     stringsAsFactors = FALSE)
unique <- read.table(file = "../alignments/small_sa_og_norRNA_alignments_uniquemapping_list.txt", 
                     header = FALSE, 
                     stringsAsFactors = FALSE)
piRBase <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_piRNA.txt", 
                      header = FALSE, 
                      stringsAsFactors = FALSE)
piRBaseplus15 <- read.table(file = "../alignments/biogenesis_alignments_norRNA_25_33/small_sa_og_norRNA_25_33_list_alignments_piRNAbaseplus15_list.txt",
                            header = FALSE,
                            stringsAsFactors = FALSE)
YRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_YRNA.txt", 
                   header = FALSE, 
                   stringsAsFactors = FALSE)
snoRNA <- read.table(fle = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_snoRNA.txt",
                     header = FALSE, 
                     stringsAsFactors = FALSE)
miRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_miRNA.txt",
                    header = FALSE, 
                    stringsAsFactors = FALSE, sep = "\t")
mRNA <- read.table(file = "../alignments/biogenesis_alignments_norRNA_25_33/small_sa_og_norRNA_25_33_list_alignments_cDNA_list.txt",
                   header = FALSE, 
                   stringsAsFactors = FALSE)
rmsk <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_repeatmasker.txt", 
                   header = FALSE, 
                   stringsAsFactors = FALSE,
                   sep = "\t")
...
write.table(voom.top.sRNA, "../data/differential_expression//GSC_vs_nonGSC_top_pval<05_differentially_expressed_putative_piRNA.csv", sep = ",", row.names = F, quote = F)
...
write.table(voom.sRNA, "../data/differential_expression/GSC_vs_nonGSC_all_differentially_expressed_putative_piRNA.csv", sep = ",", row.names = F, quote = F)
...
write.table(voom.top.sRNA$sRNA[voom.top.sRNA$mRNA], "../data/meme_files/DE_mRNA_piRNA.txt", quote=F, row.names = F, col.names = F)
...
write.table(voom.top.sRNA$sRNA[voom.top.sRNA$unique_mapping], "../data/meme_files/DE_UM_piRNA.txt", quote=F, row.names = F, col.names = F)
...
#import the desired read counts
read.counts <- read.csv(file = "../sRNA_counts/small_sa_og_norRNA_noncRNA_18_24_counts.txt", 
                        stringsAsFactors=FALSE,
                        row.names = 1)[,]
...
tRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_repeatmasker_tRNA.txt",
                   header = FALSE,
                   stringsAsFactors = FALSE)
lncRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_lncRNA.txt", 
                     header = FALSE, 
...
unique <- read.table(file = "../alignments/small_sa_og_norRNA_alignments_uniquemapping_list.txt", 
                     header = FALSE,
                     stringsAsFactors = FALSE)
piRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_piRNA.txt",
                    header = FALSE,
                    stringsAsFactors = FALSE)
YRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_YRNA.txt",
                   header = FALSE, 
                   stringsAsFactors = FALSE)
snoRNA <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_snoRNA.txt",
                     header = FALSE, 
                     stringsAsFactors = FALSE)
rmsk <- read.table(file = "../alignments/biogenesis_small_sa_og_norRNA/small_sa_og_norRNA_alignments_repeatmasker.txt", 
                   header = FALSE, 
...
miRNA <- read.table(file = "../alignments/small_sa_og_norRNA_list_alignments_miRNA.txt", 
                    header = FALSE, 
                    stringsAsFactors = FALSE, 
                    sep = "\t")
...
write.table(voom.sRNA, "../data/GSC_vs_nonGSC_miRNA_differential_expression//GSC_vs_nonGSC_all_differentially_expressed_miRNA.csv", sep = ",", row.names = F, quote = F)
write.table(voom.top.sRNA, "../data/GSC_vs_nonGSC_miRNA_differential_expression/GSC_vs_nonGSC_top_pval<05_differentially_expressed_miRNA.csv", sep = ",", row.names = F, quote = F)
...
#import the desired read counts
read.counts <- read.delim("../sRNA_counts/small_sa_og_norRNA_25_33_counts.txt", sep=",", stringsAsFactors=FALSE, row.names = 1)
...
fit <- eBayes(lmFit(voom.counts,design), trend = TRUE)

#sort fold changes sorted by p-value
voom.sRNA <- topTable(fit, coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts) )
voom.top <- topTable(fit,coef = "celltypeS", sort.by="logFC", number =nrow(voom.counts),lfc = 2,p.value = 0.05)
...
write.table(voom.sRNA, "../data/GSC_vs_nonGSC_targeting_sequences_differential_expression/GSC_vs_nonGSC_all_differentially_expressed_targeting_sequences.csv", quote=F, row.names = T, col.names = T, sep = ",")
write.table(voom.top.sRNA, "../data/GSC_vs_nonGSC_targeting_sequences_differential_expression/GSC_vs_nonGSC_top_pval<05_differentially_expressed_targeting_sequences.csv", quote=F, row.names = T, col.names = T, sep = ",")
...
#import the desired read counts
read.counts <- read.delim("../sRNA_counts/sra_all_sa_og_norRNA_25_33_read.counts.txt", sep=",", stringsAsFactors=FALSE, row.names = 1)[,]
...
colnames(read.counts) <- gsub(colnames(read.counts), pattern = "_sa_collapsed.fq", replacement = "")
...
#import the desired read counts
read.counts <- read.delim("../sRNA_counts/SRA_clusters_counts.txt", sep=",", stringsAsFactors=FALSE, row.names = 1)[,]
#select only the cell lines used in the experiment
