...
gene_expression <- read.csv("../../data_files/RNAseq_expressed_genes/GSC_vs_nonGSC_all_differentially_expressed_genes.csv", sep = ",", stringsAsFactors = F)
...
for(alignments_number in 1:length(cDNA_alignments)){
 ...
 write.table(coexpression, paste("../../data_files/coexpressions/cDNA_coexpression_", name ,".csv"), quote = F, sep = ",",row.names = F)
